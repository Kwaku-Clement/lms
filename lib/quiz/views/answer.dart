...
class Answer extends StatefulWidget {
  ...
  Answer(this.quizId, this.courseId);
...
//   void nextQuestion() {
//     if (_questionNumber < questionSnaphot.docs[index] - 1) {
//       _questionNumber++;
//     }
//   }
...
class _QuizPlayTileState extends State<QuizPlayTile> {
  // QuestionModel questionModel = widget.questionModel;
  ...
  String optionSelected = values.first;
              ...
              subtitle: Padding(
                  ...
                  child: Expanded(
                    child: Column(
                      children: values.map(
                        (value) {
                          final selected = this.optionSelected == value;
                          final color =
                          ...
                          return RadioListTile(
                              ...
                              onChanged: (value) {
                                setState(() => value = this.optionSelected);
